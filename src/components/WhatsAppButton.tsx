        ...
        <TooltipTrigger asChild>
          <div className="fixed bottom-6 right-6 z-50 group">
            <a
              ...
              className="flex h-14 w-14 animate-bounce items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:animate-none group-hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2"
